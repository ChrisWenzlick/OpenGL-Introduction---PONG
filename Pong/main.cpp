...
typedef GLFWwindow myWindowType; // Proof-of-concept for decoupling window-creation
...
int main(int argc, char** argv)
{
    ...
    // Create window
    myWindowType* window = glfwCreateWindow(800, 600, "Test Window", nullptr, nullptr); // Windowed
    ...
    image = SOIL_load_image("img/abstract.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
